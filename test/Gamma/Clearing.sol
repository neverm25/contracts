...
contract Clearing is ReentrancyGuard {
    ...
    function getSqrtTwapX96(address pos, uint32 _twapInterval) public view returns (uint160 sqrtPriceX96) {
        ...
        if (_twapInterval != 0) {
            ...
            require(_twapInterval>0,"mock clearing _twapInterval error");
            int56 tickInterval = tickCumulatives[1] - tickCumulatives[0];
            int32 twapInterval = int32(_twapInterval);
            int24 tick = int24(tickInterval / twapInterval);
